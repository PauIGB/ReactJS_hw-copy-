...
export default class RegistrationForm extends PureComponent {
    ...
    render() {    
        const { isDisabled, onHandleChange, text, onReg } = this.props;
        ...
        return (  
            <Fragment>
                ...
                <form className="form-reg" action="#">
                    <input className={regInputStyles} id="reg-input" type="text" name="text" onChange={onHandleChange} placeholder="Ваше имя" value={text} />
